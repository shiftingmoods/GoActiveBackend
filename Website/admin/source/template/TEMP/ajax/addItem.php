...
<br><br><br>
<form  method="post" action="../applications/itemAjax/saveGeneralItem.php" name='form' enctype="multipart/form-data" onsubmit="return check('form')">
<table>
<?php 
...
?>
									<table border="0" width="100%" >
										<tr>
											<td>
											<input type="radio"<?php if($value['Default']!='0' && $value['Default']!='') echo " checked "; ?> style="width:10px" name="<?php echo $id; ?>" id="<?php echo 'yes'.$outer.$optional; ?>" value="1" ><label> Yes</label>
											</td>
											<td>
											<input type="radio"<?php if($value['Default']=='0' || $value['Default']=='') echo " checked "; ?> style="width:10px" name="<?php echo $id; ?>" id="<?php echo 'no'.$outer.$optional; ?>" value="0" ><label> No</label>
											</td>
										</tr>
									</table>
<?php	
...
<?php }?>
<tr><td colspan="2" ><input type="button" onclick="postForm()" value="Add<?php echo ' '.$index->toView($table); ?>" /></td></tr>
</table>
