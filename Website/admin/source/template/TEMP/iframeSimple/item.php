...
?>
									<td><span style="float:left"><input type="button" style="width:50px" value="Edit" onclick="window.location='edit<?php echo $Table; ?>.php?id=<?php echo $value[$keyId]; ?>'" ><input type="button" style="width:50px" value="View" onclick="window.open('viewItem.php?id=<?php echo $value[$keyId]; ?>&table=<?php echo $table; ?>')" ><?php if($_SESSION['control_p_group_id']<3) echo'<input type="checkbox" style="width:30px" name="item'.$value[$keyId].'" value="'.$value[$keyId].'" />'; ?><?php echo 'Id: '.$value[$keyId]; ?></span><br/><?php if($index->hasFiles($table)) { ?><span  ><input style="width:100px;float:left" type="button" value="<?php echo $Table.' '; ?>Files" onclick="window.location='manageFiles.php?table=<?php echo $table; ?>&id=<?php echo $value[$keyId]; ?>'" ></span><?php } ?><?php if($index->checkTableIfExist($table.'_language')) { ?><span  ><input style="float:left" type="button" value="<?php echo $Table.' Language Info'; ?>" onclick="window.location='<?php echo 'edit'.$Table.'_language'; ?>.php?id=<?php echo $value[$keyId]; ?>'" ></span><?php } ?></td>
<?php
									break;
								case 'image_id' :
