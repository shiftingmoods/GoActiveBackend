...
?>
	<div id="body">	
		...
		<div id="secondColumn"  >
			...
			<form method="POST" action="../applications/custom/saveBlog_article.php" name='form' id='form' enctype="multipart/form-data" >
			...
			<?php	
											...
											case 'text':
			?>                                  <!--      -->
												<textarea  name="<?php echo $table; ?>[<?php echo $id; ?>]" id="<?php echo $Table.'-'.$outer.$optional; ?>" maxlength="<?php echo $type['length']; ?>"  class="ckeditor" cols="80"  rows="10" ></textarea>
