	...
	<div id="body">	
		...
		<div class="form_div" >
			...
			<?php	
											...
											case 'text':
			?>
												<textarea  name="<?php echo $table; ?>[<?php echo $id; ?>]" id="<?php echo $Table.'-'.$outer.$optional; ?>" maxlength="<?php echo $type['length']; ?>"  class="ckeditor" cols="80"  rows="10"><?php echo $itm[$id]; ?></textarea>
			<?php	
											break;
											default:
			?>
