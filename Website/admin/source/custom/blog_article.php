...
?>									
									...
									<td>
									<img class="icon view_icon" src="../public/design-images/view_icon.png" onclick="window.open('../custom/viewBlog_article.php?id=<?php echo $value[$keyId]; ?>&table=<?php echo $table; ?>')" >
									</td>
									<td >
