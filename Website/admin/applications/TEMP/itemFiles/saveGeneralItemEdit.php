...
//****************************************************************************************
			...
			if(array_key_exists('file',$_FILES))
			{
				if($_FILES['file']['tmp_name']!='')
				{
					...
					$data['path']=$fileName;
					//*****************  delete old file ****************************
					$oldItem=$index->getGeneralItemById($id,$table);
					$oldItem=$oldItem[$id];
					if(isset($data['control_p_folder_id']))
					{
						$oldFolder=$index->getFolderPath($oldItem['control_p_folder_id']);
						$newFolder=$dataUploadFile['folder'];
					}
					else
					{
						$oldFolder='';
					...
					$oldPath='../../../public/files/'.$oldFolder.$oldItem['path'];
					$newPath='../../../public/files/'.$newFolder.$data['path'];
