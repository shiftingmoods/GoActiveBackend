<?php
class ConstantsControl_p_admin
{
	const HOST_prod='localhost'; //online servername
	...
	const HOST_dev='127.0.0.1:3306'; //local servername
	...
	const COPYRIGHTYEAR= '2013';
	const POWEREDBYCOMPANY= '<a mailto:"info@shiftingmoods.com" >Adham Ghannam</a>';
	const MOBILE='';
	const LANDLINE='';
	const FAX='';
	const ADDRESS='';
