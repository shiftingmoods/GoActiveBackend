...
<br><br><br>
<table>
<form method="post" name="form" action="../applications/itemAjax/saveGeneralItemEdit.php" enctype="multipart/form-data" >
<tr>
<td >
</td>
<td>
...
?>
									<table border="0" width="100%" >
										<tr>
											<td>
											<input type="radio"<?php if($itm[$id]!='0' && $itm[$id]!='') echo " checked "; ?> style="width:10px" name="<?php echo $id; ?>" id="<?php echo 'yes'.$outer.$optional; ?>" value="1" ><label> Yes</label>
											</td>
											<td>
											<input type="radio"<?php if($itm[$id]=='0' || $itm[$id]=='') echo " checked "; ?> style="width:10px" name="<?php echo $id; ?>" id="<?php echo 'no'.$outer.$optional; ?>" value="0" ><label> No</label>
											</td>
										</tr>
									</table>
<?php	
...
?>
<tr><td><span id="saveChanges" ><input type="button" value="Save Changes" onClick="postForm()" /></span><?php if(isset($showLangButton)){ ?><span style="display:none" id="saveNewLang" ><input  type="button" value="Save New Language" onClick="changeFormMethod('newLang')" /></span><td/><td><?php } ?></span></td></tr>
</table>
