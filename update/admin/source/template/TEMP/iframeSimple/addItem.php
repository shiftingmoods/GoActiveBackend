...
<br><br><br>
<form  method="post" action="../applications/itemIframe/saveGeneralItem.php" name='form' id='form' enctype="multipart/form-data" >
<table>
<?php 
...
?>						
									...
									<input type="text" name="<?php echo $id; ?>" id="<?php echo $outer.$optional; ?>" value="" maxlength="<?php echo $type['length']; ?>" >
<?php	
								break;
								case 'varchar':
?>						
